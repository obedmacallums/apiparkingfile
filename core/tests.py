...
@pytest.mark.parametrize('correct_value, incorrect_value', [('okokok', '1okook'),('subdomain','SUBDOMAIN')])
...
@pytest.mark.parametrize('correct_value, incorrect_value', [('OKOKOK OKOK', '1okook'),('HOLA','Hola')])
...
@pytest.mark.parametrize('correct_value, incorrect_value', [('file.txt', '*.123*'),('file','$$file.txt')])
...
@pytest.mark.parametrize('subdomain, description', [('okok', 'DESCRIPTION')])
